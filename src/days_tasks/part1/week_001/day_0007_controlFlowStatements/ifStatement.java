package days_tasks.part1.week_001.day_0007_controlFlowStatements;
...
public class ifStatement {
	...
	public static void main(String[] args) {
		...
		if ( y == 20) {
			x = 5;
			System.out.println("You attained the x" + x);
		}
		...
		double paRate = 1.5;
		int statement = 40;
		if (statement>=40 & paRate <= 2) {
			
			System.out.println("by bye hepinis");
